...
function App() {
  ...
  const fetchExcuse = () =>
  {
    ...
    .then(res => res.json()).then(data => {console.log(data); setExcuse(data[0].excuse)})
  ...
  return (
    <div className="App">
      <div className = "Header">
        <h1 className = "headerText">Excuse Generator</h1>
        <h2 className = "subHeaderText">The perfect tool to get out of something</h2>
      </div>
      <div className = "Main">
